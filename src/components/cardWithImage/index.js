...
const CardWithImage = ({ title, containerStyle, titleStyle, imgStyle, rightIcon,label,labelTitle,labelStyle,onPress }) => {
    return (
        <TouchableOpacity onPress={onPress} style={[cardWithImageStyle.mainContainer, containerStyle]}>
            {
                label
                && <View>
